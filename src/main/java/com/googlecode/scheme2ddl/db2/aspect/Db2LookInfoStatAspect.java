...
public class Db2LookInfoStatAspect {
    ...
    public void prettyPrint(String schemaName) {
        ...
        sb.append("-------------------------------------------------------");
        sb.append(lSep);
        sb.append(String.format("%d alter table with auto generated sequence values statements was filtered by (needToFilterAlterTableAutoGeneratedSequence=true) rule", listExludedByFilter.size()));
        sb.append(lSep);
        sb.append(lSep);
