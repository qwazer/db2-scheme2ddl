...
public class UserObjectStatAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.googlecode.scheme2ddl.db2.UserObjectProcessor.process(..)) &&"
            + "args(userObject)",
            returning = "retVal")
    ...
    @AfterThrowing(pointcut = "execution(* com.googlecode.scheme2ddl.db2.UserObjectProcessor.process(..)) &&"
            + "args(userObject)",
            throwing = "ex")
