...
//    }
    ...
    public void testDefaultTemplate() throws Exception {
        for (UserObject userObject : list) {
            String fileName = FileNameConstructor.pluralaze(FileNameConstructor.abbreviate(userObject.getType())).replace(" ", "_") + "/" + userObject.getName() + ".sql";
    ...
    public void testTemplateWithTypeMix() throws Exception {
        ...
        fileNameConstructor.afterPropertiesSet();
        for (UserObject userObject : list) {
            String type = FileNameConstructor.abbreviate(userObject.getType().toLowerCase()).replace(" ", "_");
            String typePlural = FileNameConstructor.pluralaze(FileNameConstructor.abbreviate(userObject.getType())).replace(" ", "_");
    ...
    public void testApplyExtensionRules() {
        ...
        userObject.setSchema("");
        String fileName = FileNameConstructor.pluralaze(FileNameConstructor.abbreviate(userObject.getType())).replace(" ", "_") + "/" + userObject.getName() + ".vw";
        assertEquals(fileName, fileNameConstructor.map2FileName(userObject));
    }
